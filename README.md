...
![Динамика продаж](plots/plot1_dynamics.png)

### 2. Сравнение прогнозов моделей
![Сравнение прогнозов](plots/plot2_predictions.png)

### 3. Сравнение метрик
![Метрики](plots/plot3_metrics.png)

### 4. Лучшая модель с прогнозом
![Лучшая модель](plots/plot4_best_model.png)

### 5. Прогноз на будущее
![Прогноз](plots/plot5_forecast.png)
